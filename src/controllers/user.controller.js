...
const registerUser = asyncHandler(async (req, res) => {
  ...
  // step 5: upload image to cloudinary, check avatar
  // step 6: create user object in db
  // step 7: return response but without password and refreshtoken
  // step 8: if user created return response else return err
